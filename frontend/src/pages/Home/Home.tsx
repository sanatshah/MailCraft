    ...
    <div className="home-dashboard" data-testid="home-dashboard">
      <header className="home-header">
        <div className="home-header-intro">
          <h1 className="home-title">Email metrics</h1>
          <p className="home-subtitle">
            Monitor delivery, failures, and opens for the selected period.
          </p>
        </div>
      ...
      {trends && (
        <section className="home-section" aria-labelledby="home-trends-heading">
          ...
          {trends.series.length > 0 ? (
            <>
              <p className="home-section-description" id="home-trend-description">
                Stacked bars compare sent, failed, and opened messages for each day.
              </p>
              ...
              <table className="home-sr-table" data-testid="home-trend-table">
                <caption>Daily trend data</caption>
                <thead>
                  <tr>
            ...
            <p className="home-empty-section" data-testid="home-trend-empty">
              No delivery or open events were recorded in this period.
            </p>
          )}
        </section>
      )}
          ...
          <section className="home-section" aria-labelledby="home-top-heading">
            ...
            {topTemplates.templates.length > 0 ? (
              ...
              <p className="home-empty-section" data-testid="home-top-empty">
                No template sends were recorded in this period.
              </p>
            )}
          </section>
        )}
          ...
          <section className="home-section" aria-labelledby="home-fail-heading">
            ...
            {overviewData.recent_failures.length > 0 ? (
              ...
              <p className="home-empty-section" data-testid="home-fail-empty">
                No failures were reported in this period.
              </p>
            )}
          </section>
        )}

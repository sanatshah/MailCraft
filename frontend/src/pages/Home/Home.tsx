...
export function Home() {
  ...
  const hasTrendActivity = Boolean(
    trends?.series.some((d) => d.sent > 0 || d.failed > 0 || d.opens > 0),
  )
    ...
    <div className="home-dashboard" data-testid="home-dashboard">
      <header className="home-header">
        <div className="home-header-copy">
          ...
          <p className="home-subtitle">Track send volume, failures, and recipient engagement.</p>
        </div>
        ...
        <section className="home-section" aria-labelledby="home-trends-heading">
          ...
          {hasTrendActivity ? (
            <>
              ...
              <table className="home-sr-only" data-testid="home-trend-table">
                <caption>Daily trend data for the last {days} days</caption>
                <thead>
                  <tr>
                    <th scope="col">Day</th>
            ...
            <p className="home-section-empty" data-testid="home-trend-empty">
              No daily trend activity in the selected period yet.
            </p>
          )}
        </section>
      )}
          ...
          <section className="home-section" aria-labelledby="home-top-heading">
            ...
            {topTemplates.templates.length > 0 ? (
              ...
              <p className="home-section-empty" data-testid="home-top-empty">
                No templates have sent activity in this period.
              </p>
            )}
          </section>
        )}

...
export function Home() {
  ...
  const hasTrendData = trendSeries.some((day) => day.sent + day.failed + day.opens > 0)
  const hasTopTemplates = (topTemplates?.templates.length ?? 0) > 0
  const hasRecentFailures = (overviewData?.recent_failures.length ?? 0) > 0
  const isEmpty =
    overview &&
    ...
    <div className="home-dashboard" data-testid="home-dashboard">
      <header className="home-header">
        <div className="home-header-copy">
          <h1 className="home-page-title">Email metrics dashboard</h1>
          <p className="home-page-subtitle">
            Monitor delivery and engagement over the last {days} days.
          </p>
        </div>
      ...
      {trends && (
        <section className="home-section" aria-labelledby="home-trends-heading">
          ...
          {!hasTrendData ? (
            <div className="home-section-empty" data-testid="home-trends-empty">
              <p>No trend data yet for this period.</p>
            </div>
          ) : (
            <>
              ...
              <table className="home-sr-only" aria-label={`Daily activity totals for the last ${days} days`}>
                <thead>
                  <tr>
        ...
        {topTemplates && (
          <section className="home-section" aria-labelledby="home-top-heading">
            ...
            {hasTopTemplates ? (
              ...
              <div className="home-section-empty" data-testid="home-top-empty">
                <p>No template activity yet for this period.</p>
              </div>
            )}
          </section>
        )}
        ...
        {overviewData && (
          <section className="home-section" aria-labelledby="home-fail-heading">
            ...
            {hasRecentFailures ? (
              ...
              <div className="home-section-empty" data-testid="home-fail-empty">
                <p>No failures reported for this period.</p>
              </div>
            )}
          </section>
        )}

    ...
    <div className="home-dashboard" data-testid="home-dashboard">
      <header className="home-header">
        <div className="home-header-copy">
          ...
          <p className="home-page-subtitle">
            Track email delivery health, engagement, and failures in one place.
          </p>
        </div>
      ...
      {isEmpty && (
        <div className="home-empty-banner" data-testid="home-empty-banner">
          ...
          <p>
            We could not find events in the last {days} days. When your send pipeline posts events
            to <code className="home-code">POST /api/events/message</code> or recipients load the
            open tracking pixel, dashboard metrics will appear here.
          </p>
        </div>
      )}
          ...
          {trends.series.length > 0 ? (
            <>
              ...
              <table className="home-trend-table sr-only" data-testid="home-trend-table">
                <caption>Daily activity totals for the last {days} days</caption>
                <thead>
                  <tr>
            ...
            <p className="home-empty-section" data-testid="home-trend-empty">
              No daily activity has been recorded for the selected period.
            </p>
          )}
        </section>
      )}
          ...
          <section className="home-section" aria-labelledby="home-top-heading">
            ...
            {topTemplates.templates.length > 0 ? (
              ...
              <p className="home-empty-section" data-testid="home-top-empty">
                No template activity yet. Send emails with templates to populate this ranking.
              </p>
            )}
          </section>
        )}
          ...
          <section className="home-section" aria-labelledby="home-fail-heading">
            ...
            {overviewData.recent_failures.length > 0 ? (
              ...
              <p className="home-empty-section" data-testid="home-fail-empty">
                No failed deliveries were recorded in the selected period.
              </p>
            )}
          </section>
        )}

...
export function TemplateList() {
  const { templates, loading, error, createTemplate, deleteTemplate, duplicateTemplate } = useTemplates()
  ...
  const handleDuplicate = async (id: string) => {
    try {
      ...
      setDuplicateStatus(`Duplicated as "${duplicated.name}"`)
    } catch {
      setDuplicateStatus(null)
      setDuplicateError('Failed to duplicate template')
    }
  }
  ...
  return (
    <div className="template-list" data-testid="template-list">
      ...
      {duplicateStatus && <p className="template-list-feedback success">{duplicateStatus}</p>}
      {duplicateError && <p className="template-list-feedback error">{duplicateError}</p>}
